...
\begin{document}
	...
	{Integração de modelos de ML em produção via APIs, otimizando inferência de modelos para detecção de anomalias em tempo real e análise preditiva.}
	\resumeItemListEnd
	...
	{Liderança no desenvolvimento de um produto IoT, incluindo a implementação do protocolo MQTT e armazenamento de séries temporais usando InfluxDB.}
	\resumeItemListEnd
